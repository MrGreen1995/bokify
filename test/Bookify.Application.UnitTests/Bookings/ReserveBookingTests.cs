...
namespace Bookify.Application.UnitTests.Bookings
{
    public class ReserveBookingTests
    {
        ...
        private static readonly ReserveBookingCommand Command = new(Guid.NewGuid(), Guid.NewGuid(), new DateOnly(2024, 1, 1), new DateOnly(2025, 1, 10));
        ...
        [Fact]
        public async Task Handle_Should_ReturnFailure_WhenApartnentIsBooked()
        {
            // Arrange
            var user = UserData.Create();
